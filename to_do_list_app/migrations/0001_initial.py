# Generated by Django 4.2.13 on 2024-05-22 11:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', models.ManyToManyField(related_name='tasks', to='to_do_list_app.tag')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('tasks', models.ManyToManyField(blank=True, related_name='users', to='to_do_list_app.task')),
